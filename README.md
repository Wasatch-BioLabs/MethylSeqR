...
## Version 0.5.0
*Note: New releases are now found at [our new github repository](https://github.com/Wasatch-Biolabs-Bfx/MethylSeqR). This was the first release - changes may occur that significantly change the functionality and structure of the data and functions. The user should be aware that subsequent releases may break code written using earlier releases.*
